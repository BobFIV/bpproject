...
// configuration step. It creates a namespace called `bpproject`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", bpproject::cmake::project_name, bpproject::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", bpproject::cmake::project_version);
      return EXIT_SUCCESS;
    }
